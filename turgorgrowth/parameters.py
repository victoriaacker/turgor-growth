...
class HiddenZoneParameters(OrganParameters):
    ...
    def __init__(self):
        ...
        #V1
        self.epsilon = {'x': 0.3, 'y': 0.2, 'z': 0.4}  #: Dimension-specific elasticity in relation to reversible dimensional changes (MPa). x: width, y: thickness, z: length.
...
class XylemParameters(object):
    ...
    def __init__(self):
        ...
        self.R_xylem = 0.05    #: Flow resistance between xylem and shoot organs (Mpa s g-1 m)
        self.R_soil = 0.01    #: Flow resistance between soil and xylem (Mpa s g-1 m)
